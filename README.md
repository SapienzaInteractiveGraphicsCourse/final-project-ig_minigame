...
<div class="row">
  <div class="column">
    <img src="report/images/scenario3.png"  width = "60%" height = "60%">
</div> 
...
<div class="row">
  <div class="column">
    <img src="report/images/coin.png"  width = "25%" height = "25%">
</div> 
...
In the Main menu, press **Disable/Enable sound** to disable/enable sounds and game music and **Start Game** to start a match. Switch the slider to change the game difficulty. 
